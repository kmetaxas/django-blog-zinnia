...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.content_markup'
        db.add_column(u'zinnia_entry', 'content_markup',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.content_markup'
        db.delete_column(u'zinnia_entry', 'content_markup')
    ...
    models = {
        ...
        'zinnia.entry': {
            ...
            'content_markup': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
